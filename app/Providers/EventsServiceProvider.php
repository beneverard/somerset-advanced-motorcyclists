...
class EventsServiceProvider extends ServiceProvider
{
	 ...
	 */
	protected function getEventColour($event_name) {
	 ...
	 * @return void
	 */
	protected function fetchLatestEvents() {
		...
		foreach ($results->getItems() as $event) {
			...
			$colour = $this->getEventColour($name);
	...
	protected function addEventsResetButton()
	{
